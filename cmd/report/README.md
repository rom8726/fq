...
`manifest.json`. It renders throughput, latency percentiles, error rate, profile
metadata, run metadata, stress results, and comparison notes. Use `-output -` to print
